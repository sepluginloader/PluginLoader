...
#### Manual
To install without the workshop, the files must be copied into the game folder manually. If you install manually, you will need to reinstall the loader to update it.
